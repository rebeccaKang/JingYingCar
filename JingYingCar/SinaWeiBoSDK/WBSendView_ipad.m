...
@interface WBSendView_ipad (Private)
...
@implementation WBSendView_ipad
...
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 768, 960)])
    {
        ...
        // add the panel view
        panelView = [[UIView alloc] initWithFrame:CGRectMake(16, 75, 756, 885)];
        panelImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 756, 885)];
