//
//  MagazineDownloadedViewController_IPad.h
//  JingYingCar
//
...
@interface MagazineDownloadedViewController_IPad : UIViewController<UITableViewDelegate,UITableViewDataSource,ASIHTTPRequestDelegate>
{
