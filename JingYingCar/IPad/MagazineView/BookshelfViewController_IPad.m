//
//  BookshelfViewController_IPad.m
//  JingYingCar
//
...
@interface BookshelfViewController_IPad ()
...
{
    MagazineUndownloadedViewController_IPad *con_magazineInfo = [[MagazineUndownloadedViewController_IPad alloc] init];
